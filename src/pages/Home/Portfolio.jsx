  ...
  const projects = [
    {
      ...
      description:
        "A spontaneous griddy-off vs. friends. Get GriddyScored (w/ computer vision), and rise to the top of the GriddyBoard! 💃🕺💯",
    },
    {
      title: "soundchain 🏆",
      titleColor: "black",
      ...
      description:
        "Stream, crowdfund, and take control of your music career—no record label needed, just you, your fans, and blockchain-powered beats! 🎶💸🎧",
    },
    {
      ...
      description:
        "Take the quiz, let our algorithm find your colour season, and unlock a personalized wardrobe that’s all you! 🖤👗🎨",
    },
    {
      title: "Presentify",
      titleColor: "white",
      ...
      description:
        "Turn your words into a dynamic presentation with real-time subtitles, visuals, and audio effects—making presentations easier, more interactive, and accessible for all! 🎤📊✨",
    },
  ];
    ...
    <section id="portfolio" className="projects-section">
      <div className="project-container">
        <div className="header-container">
          ...
          <a
            href="https://devpost.com/mwchelle?ref_content=user-portfolio&ref_feature=portfolio&ref_medium=global-nav"
            target="_blank"
            rel="noopener noreferrer"
            className="devpost-header"
          >
        ...
        <div className="projects-add">
          ...
          <h3>
            <a href="https://github.com/mwchelle" className="project-link">
          ...
          <h3>
            <a
              href="https://docs.google.com/presentation/d/1q2LfLKEAdFN2EVtVyayNjk4tBc3ljU5J5sVbL5cSoVs/edit?usp=sharing"
