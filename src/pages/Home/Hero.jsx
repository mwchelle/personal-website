  ...
  const [stickers, setStickers] = React.useState([
    {
      ...
      src: Bobo,
      alt: "Bobo Sticker",
      subtitle: "Bobo & Coco Collector",
    },
    {
      id: 2,
      src: Williams,
      alt: "Williams Sticker",
      subtitle: "Go Williams! + Oscar Piastry",
    },
    { id: 3, src: Panda, alt: "Panda Sticker", subtitle: "Fav Animal <3" },
    {
      ...
      src: Raptor,
      alt: "Raptor Sticker",
      subtitle: "Sad Raptors Fan ):",
    },
    {
      id: 5,
      src: Skullpanda,
      alt: "Skullpanda Sticker",
      subtitle: "Skullpanda Enjoyer",
    },
    ...
    <section id="hero" className="hero-section">
      <div className="hero-text">
        <div className="hero-content-header">
          <h2 className="hero-start">hi, i'm michelle!</h2>
          <h1 className="hero-header">
            i'm a{" "}
            <em>
              <span className="hero--section--changing" ref={el} />
            </em>{" "}
            who believes in value-based innovation in technology.
          </h1>
        </div>
        <div className="hero-content-about">
          ...
          <div className="hero-currently">
            <h3>currently</h3>
            <h4>4th year cs + business @ ubc</h4>
          </div>
          <div className="hero-driven">
            <h3>driven by</h3>
            <h4>well-governed products that help people help people</h4>
          </div>
          <hr className="custom-hr" />
          ...
          <div className="hero-prev">
            <h3>previously</h3>
            <h4>product @ amex, tech risk @ kpmg, ux research @ huawei</h4>
          </div>
          <div className="hero-etc">
            <h3>etc.</h3>
            <h4>sponsorships @ nwplus, vp ext @ ubc esports</h4>
          </div>
        </div>
        ...
        <div className="hero-stickers">
          {stickers.map((sticker) => (
            <div key={sticker.id} className="sticker-container">
              <img src={sticker.src} alt={sticker.alt} className="sticker" />
              <div className="sticker-subtitle">{sticker.subtitle}</div>
            </div>
          ))}
        </div>
      </div>
